...
public class Course {
	...
	public String toString() {
		String course= "";
		course="Course " + _name + ", min grade to pass the course is: " + _minGrade + ", Course professor is " + _professor.getName() + ", course year is '" + _year + "'" ;
		
		course += ", students(" + _students.size() + "): " ;
		
		for( int i=0; i<_students.size()-1; i++) {
			course +=_students.get(i).getName() + ", ";
		}
		course += _students.get(_students.size()-1).getName();
		return course;
	}
